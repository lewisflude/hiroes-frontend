...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProfileCard = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProfileCardList = __webpack_require__(169);

	var _ProfileCardList2 = _interopRequireDefault(_ProfileCardList);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(_ProfileCardList2.default, { source: 'https://hiroes.herokuapp.com/directory' });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfileCardList = function (_React$Component) {
	  _inherits(ProfileCardList, _React$Component);

	  function ProfileCardList() {
	    _classCallCheck(this, ProfileCardList);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ProfileCardList).apply(this, arguments));
	  }

	  _createClass(ProfileCardList, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var idList = $.getJSON(this.props.source);
	      console.log(idList);
	      return _react2.default.createElement(
	        'div',
	        null,
	        idList.map(function (id, index) {
	          return _react2.default.createElement(_ProfileCard2.default, { key: index, source: this.props.source, id: id });
	        })
	      );
	    }
	  }]);
	...
	exports.default = ProfileCardList;
	  ...
	  _createClass(ProfileCard, [{
	    ...
	    value: function componentDidMount() {
	      this.serverRequest = $.getJSON(this.props.source, function (result) {
	        var userProfile = result[this.props.id];
	        this.setState({
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement("img", { "class": "profile-card__picture", src: this.state.picture }),
	        _react2.default.createElement(
	          "h2",
	          { "class": "profile-card__talent" },
	          this.state.talent
	        ),
	        _react2.default.createElement(
	          "h3",
	          { "class": "profile-card__subtalent" },
	          this.state.subtalent
	        ),
	        _react2.default.createElement(
	          "p",
	        ...
	        _react2.default.createElement(
	          "p",
	          { "class": "profile-card__minprice" },
	          "£",
	          this.state.minprice
	        ),
	        _react2.default.createElement(
	          "p",
	          { "class": "profile-card__unit" },
	          this.state.unit
	        )
	      );
	    }
